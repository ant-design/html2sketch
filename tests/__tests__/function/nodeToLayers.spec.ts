...
<svg id="use-svg" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="14" height="14"><defs><path id="a" d="M5.7 8.3L2.9 5.5 1.5 6.9l4.2 4.2 6.4-6.4-1.4-1.4-5 5z"/></defs><use xlink:href="#a" overflow="visible" fill-rule="evenodd" clip-rule="evenodd" fill="#fff"/></svg>

<input id="input-center" type="text" value="123456" class="inputv">
</div>
`;
  ...
  it('svg-use 正常解析', async () => {
    const node = document.getElementById('use-svg') as HTMLInputElement;
    const layers = await nodeToLayers(node);
