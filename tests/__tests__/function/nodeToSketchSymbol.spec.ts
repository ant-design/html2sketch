...
<div>
  ...
  <div id="symbol-params"><div class="test">内容</div></div>
</div>
`;
        ...
        layerParams: [
          {
            ...
            resizing: [ResizingConstraint.Height, ResizingConstraint.Width],
          },
        ],
      });
      expect(symbol.layers[0].class).toBe('text');
      expect(symbol.layers[0].resizingConstraint).toBe(
        calcResizingConstraint(
