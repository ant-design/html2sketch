...
`;
  ...
  describe('icon 类型', () => {
    ...
    it('up-circle 图形正常解析', async () => {
      ...
      expect(json).toStrictEqual(upCircleParserJSON);
    });
  });
